# ADR-001: Keep codec-smtp as an Independent Gnalloy Module
...
`codec-smtp` is published as `gnalloy.org/codec-smtp` and owns this responsibility: SMTP line-oriented message codecs for Gnalloy pipelines.
