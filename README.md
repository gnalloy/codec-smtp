...
SMTP line-oriented message codecs for Gnalloy pipelines.
...
- Import path: `gnalloy.org/codec-smtp`
- Repository: `github.com/gnalloy/codec-smtp`
- Default branch: `dev`
- Preview install: `go get gnalloy.org/codec-smtp@dev`
- License: Apache-2.0

## Install
```bash
go get gnalloy.org/codec-smtp@dev
go doc gnalloy.org/codec-smtp
...
This repository owns: SMTP line-oriented message codecs for Gnalloy pipelines.
